...
require(".".DIRECTORY_SEPARATOR."core-s".DIRECTORY_SEPARATOR."broswor.php");
...
class GPage extends ProcessVillagePage{
        ...
        public function load(){
            ...
            $mplus->dispose();
                        ...
                        $p = "2013-04-27 08:22:24";
                      //  $mprof->resetproFlag($p,$this->player->playerId);
...
$a = "<b>".$name."</b> <div class='nextlvl'>تكلفة البناء للمستوى ".$nl2.":</div><div class='resinfo'><span><img class='r1' src='core-s/st-s/x.gif'> ".$r1."</span><span><img class='r2' src='core-s/st-s/x.gif'> ".$r2."</span><span><img class='r3' src='core-s/st-s/x.gif'> ".$r3."</span><span><img class='r4' src='core-s/st-s/x.gif'> ".$r4."</span></div>";
}
