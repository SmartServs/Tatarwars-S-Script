...
class GPage extends SecureGamePage
    ...
    function GPage()
        ...
        $this->viewFile        = 'Adminstatis4.phtml';
		   ...
		   if ($this->isAdmin)
                ...
                if (!$this->isPost())
                    ...
                    if ((isset($_GET['_jsdue']) && 0 < intval($_GET['_jsdue'])))
                        ...
                        else if ((((isset($_GET['SetGoldthes']) && 0 < intval($_GET['SetGoldthes'])) && isset($_GET['_g'])) && 0 <= intval($_GET['_g'])))
                            {
                            $m->setPlayerGold(intval($_GET['SetGoldthes']), intval($_GET['_g']));
