                ...
                if ($this->isPost ()) {
                        ...
                        foreach ($_POST['a2'] as $tribeId=>$v) {
                                if ($tribeId != 1 && $tribeId != 2 && $tribeId != 3 && $tribeId !=4 && $tribeId != 7  && $tribeId != 6) {
                                        $this->errorText = 'لم يتم تحديد نوع القوات المدافعة بشكل صحيح';
                                        return;                                
                                }
                        }
                        ...
                        $attackTroops = $m->_getTroopWithPower ($troops, $troopsPower, TRUE, $heroLevel, $wringerPower, 0);
                        ...
                        foreach ($_POST['t2'] as $tribeId=>$troopArray) {
                                ...
                                $defenseTroops[$tribeId] = $m->_getTroopWithPower ($troops, $troopsPower, FALSE, 0, 0, $wallLevel);
                        ...
                        // get the war result
                        $this->warResult = $m->getWarResult ($attackTroops, $defenseTroops, $totalDefensePower, $wallLevel, $palLevel, (isset ($_POST['ktyp']) && intval ($_POST['ktyp']) == 2), FALSE);
                        $m->dispose ();
                }
