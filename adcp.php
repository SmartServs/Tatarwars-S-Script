           ...
           $this->redirect('village1');
            exit( 0 );
                                ...
                                if ( isset($_GET['p']) AND isset($_GET['punishment']) OR isset($_GET['newtroops']))
                {
                                ...
                                $this->redirect('adcp.php?t=0&p='.$_GET['p'].'&punishments');
                                }
                                }
                                ...
                                $this->redirect('adcp.php?t=0&p='.$_GET['p'].'&newtroopss');
                                }
                                }
                        ...
                        if ( $this->selectedTabIndex == 2 )
                        {
                                ...
                                if ( $this->isPost() )
                                {
                                $m->UpdateGsummaryData ( intval($_POST['players_count']), intval($_POST['active_players_count']), intval($_POST['almgoul_players_count']), intval($_POST['Arab_players_count']), intval($_POST['faron_players_count']), intval($_POST['Roman_players_count']), intval($_POST['Teutonic_players_count']), intval($_POST['Gallic_players_count']) );
                                $this->errorTable = LANGUI_ADCP_E1;
                                }
                        }
