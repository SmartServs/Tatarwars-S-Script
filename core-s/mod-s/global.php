...
$date = date("y-m-d G:i:s");
        ...
        public function getattack($villageId ,$num1, $villageId ,$num2){
        ...
        public function getattackp($villageId ,$num1, $villageId ,$num2){
