<?php
 	...
 	$rootDir = realpath($_SERVER["DOCUMENT_ROOT"]);
        require($rootDir.'/core-s/conf-s/tcex-con.php');
        ...
        class VCConfig {
            ...
            public function connectSQL()
            {
                ...
                $host = $AppConfig['db']['webhost'];
                $dbUser = $AppConfig['db']['webuser'];
                $dbPassword = $AppConfig['db']['webpassword'];
                $database = $AppConfig['db']['webdatabase'];
